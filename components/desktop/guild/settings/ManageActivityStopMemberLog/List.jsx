...
import { setParams } from '@redux/modules/guild/settings/manage_activity_stop_member_log';
...
const List = () => {
    ...
    const state = useSelector(state => state.settings.manage_activity_stop_member_log);
