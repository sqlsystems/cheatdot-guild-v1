            ...
            <div className={style.layout_box}>
                <div className={style.user_info}>
                    <div className={style.img_wrap}>
                        ...
                        {props.is_edit &&
                            <button type="button" className={style.btn_edit} onClick={() => window.open(`/${params.query.channel}/members/edit`, 'edit', "left=50, top=50, width=500, height=700, scrollbars=1")}>
