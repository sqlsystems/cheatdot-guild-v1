...
const UserHome = (props) => {
    ...
    const renderSubPage = useCallback(() => {
        if (!params.query.type || params.query.type === 'write') {
            return <Write { ...props } />;
        } else if (params.query.type === 'comment') {
        ...
        <>
            <div className={style.layout_box}>
                <div className={style.user_info}>
                    ...
                    <div className={style.info}>
                        ...
                        <div className={style.info_detail}>
                            ...
                            <span>작성 댓글<em>{props.total_comment}</em></span>
                        </div>
                    </div>
                </div>
                ...
                <div className={style.tab_menu}>
                    <ul>
                        <li>
                            <Link href={`/guild/${params.query.channel}/members/${params.query.mb_id}?type=write`} className={(!params.query.type || params.query.type === 'write') ? style.on : null}>작성글</Link>
                        </li>
                        <li>
                            <Link href={`/guild/${params.query.channel}/members/${params.query.mb_id}?type=comment`} className={params.query.type === 'comment' ? style.on : null}>작성 댓글</Link>
                        </li>
                        {props.is_edit &&
                            <li>
                                <Link href={`/guild/${params.query.channel}/members/${params.query.mb_id}?type=buy_history`} className={params.query.type === 'buy_history' ? style.on : null}>구매기록</Link>
                            </li>
                        }
                    </ul>
                </div>
