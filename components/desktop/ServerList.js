                ...
                <div className={style.guild_list}>
                    <ul>
                        {props.list.map(c => {
                            return (
                                <li key={c.channel}>
                                    <Link href={`/channels/${c.channel}`} target="_blank">
                                        <div className={style.img_wrap}>
                                            {/* 배너 이미지 비율과 안맞아서 추가로 등록해야하지 않을까 싶습니다 */}
                                            <img src="https://cdn.gametoc.co.kr/news/photo/202309/75833_234553_4219.jpg" alt="배너 이미지"/>
                                            <div className={style.owner_profile}>
                                                <img src="/img/no_profile.svg" width={80} height={80} alt="길드 주인 프로필 이미지" />
                                            </div>
                                        </div>
